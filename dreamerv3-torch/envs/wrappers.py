...
class TimeLimit(CutomGymnasiumWrapper):
...
class NormalizeActions(CutomGymnasiumWrapper):
    def __init__(self, env):
        super().__init__(env)
...
class OneHotAction(CutomGymnasiumWrapper):
    def __init__(self, env):
...
class RewardObs(CutomGymnasiumWrapper):
    def __init__(self, env):
        super().__init__(env)
...
class SelectAction(CutomGymnasiumWrapper):
...
class UUID(CutomGymnasiumWrapper):
    def __init__(self, env):
        super().__init__(env)
